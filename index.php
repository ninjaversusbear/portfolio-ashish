...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="./images/pppngcrop.png">
        ...
        <div class="col-sm mb-2">
          ...
          <ul>
            <li class="nav-item-bio">
              <a class="text-white" style="text-decoration: none;" href="https://www.linkedin.com/in/ashish-regmi-5b9a02228/" target="_blank">Linkedin</a>
            </li>
            <li class="nav-item-bio">
              <a class="text-white" style="text-decoration: none;" href="https://www.facebook.com/ashish.regmi.142/" target="_blank">Facebook</a>
            </li>
            <li class="nav-item-bio">
              <a class="text-white" style="text-decoration: none;" href="https://www.instagram.com/ashishregmi1998/" target="_blank">Instagram</a>
            </li>
            <li class="nav-item-bio">
              <a class="text-white" style="text-decoration: none;" href=" https://github.com/ninjaversusbear" target="_blank">Github</a>
            </li>
          </ul>
        </div>
        <div class="col">
